...
- End with an invitation to go deeper, not a sales close.
...
**Data Sovereignty:** Community data belongs to communities. Personal data is never aggregated or shared without explicit consent protocols documented in the source file.

**Bias Disclosure:** When citing data or AI-generated analysis, note if the underlying dataset may reflect historical inequities — e.g., collected primarily in urban areas, by non-community researchers, or excluding marginalised groups. Do not present any output as neutral.

**Resource Honesty:** If the organisation cannot currently deliver a committed outcome with integrity, surface that plainly. Never overpromise to secure a grant or partnership relationship. A funder who discovers a gap later is worse than one who knows about it now.
